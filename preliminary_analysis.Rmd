...
park_all <- park_all %>%
  mutate(park_check = ifelse(`Call Type` == "Park Check", `Call Type`, NA),
         extra_patrol = ifelse(`Call Type` == "Extra Patrol", `Call Type`, NA),
         `Call Type` = ifelse(`Call Type` == "Park Check", NA, `Call Type`),
         `Call Type` = ifelse(`Call Type` == "Extra Patrol", NA, `Call Type`)) 
```
